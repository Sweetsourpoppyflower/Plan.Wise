...
//        }
        ...
        Taken.add(new taak(3, "Appie", "Project afronden", "Eindrapport schrijven", "2025-04-27", "Thuis", true));
        Taken.add(new taak(4, "Sophie", "Doktersafspraak", "Controle bij de huisarts", "2025-04-07", "Ziekenhuis", true));
        Taken.add(new taak(5, "Appie", "Auto wassen", "Binnen en buiten schoonmaken", "2025-04-23", "Garage", false));
        ...
        Taken.add(new taak(8, "Jamal", "Verjaardagscadeau kopen", "Cadeau voor vriend kiezen", "2025-04-21", "Winkelcentrum", true));
        Taken.add(new taak(9, "Sophie", "Tuinieren", "Planten water geven en snoeien", "2025-04-13", "Tuin", false));
        Taken.add(new taak(10, "Appie", "Presentatie voorbereiden", "Slides maken en oefenen", "2025-04-18", "Kantoor", true));

        hoortBij hoortBij = new hoortBij();
        focusModus focusModus = new focusModus();

        focusModus.setTaken(Taken);
        hoortBij.setTaken(Taken);
        hoortBij.vandaagsTaken();
        hoortBij.vanDeWeeksTaken();
